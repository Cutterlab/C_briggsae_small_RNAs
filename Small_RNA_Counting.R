...
name <- "AF14-1"
bam_file <- paste("~/Small RNA BAMs/", name, "Aligned.sortedByCoord.out.bam",
                  sep = "")
...
# These files were created in Quantification_Annotation_Script_AF16.R and
# Quantification_Annotation_Script_HK104.R
if (grepl("AF", name)) {
...
save(results.sizes, file = "resultsSizes.RData")
